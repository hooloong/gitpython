...
class MyWindow(QtGui.QMainWindow):
    ...
    def paintEvent(self, envent):
        ...
        # startposx = 20 #self.tableWidget_Paras.x()
        # startposy = 20 #self.tableWidget_Paras.y() + self.tableWidget_Paras.height() + 60
        # for i in range(8):
        #     for j in range(8):
        #         var = self.pwm[j * self.tableWidget_PWM.rowCount() + i]
        #         br = (var & 0xFFF) >> 4
        #         color = QtGui.QColor(br, br, br)
