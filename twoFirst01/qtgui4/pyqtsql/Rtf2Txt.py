...
"""
import qtgui4.pyqtsql.rtf.RtfParser
import sys
...
class Rtf2Txt(qtgui4.pyqtsql.rtf.RtfParser.RtfParser):
    def __init__(self,foutput):
        qtgui4.pyqtsql.rtf.RtfParser.RtfParser.__init__(self)
        self.foutput = foutput
...
if __name__ == '__main__':
    if len(sys.argv) != 2:
        ...
        foutput = open(finput.name + '.txt','w')
