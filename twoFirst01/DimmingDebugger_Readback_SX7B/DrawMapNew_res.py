...
#
# Created: Wed Aug 16 15:59:14 2017
...
class Ui_Form_mLut(object):
    def setupUi(self, Form_mLut):
        ...
        self.gridLayout_2.addWidget(self.pushButton_save, 7, 0, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.pushButton_output, 5, 1, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.pushButton_draw, 5, 0, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.pushButton_load, 6, 0, 1, 1)
        self.radioButton_sdr = QtGui.QRadioButton(self.gridLayoutWidget_2)
        self.radioButton_sdr.setChecked(True)
        self.radioButton_sdr.setObjectName(_fromUtf8("radioButton_sdr"))
        self.gridLayout_2.addWidget(self.radioButton_sdr, 6, 1, 1, 1)
        self.radioButton_hdr = QtGui.QRadioButton(self.gridLayoutWidget_2)
        self.radioButton_hdr.setObjectName(_fromUtf8("radioButton_hdr"))
        self.gridLayout_2.addWidget(self.radioButton_hdr, 7, 1, 1, 1)
    ...
    def retranslateUi(self, Form_mLut):
        ...
        self.radioButton_sdr.setText(_translate("Form_mLut", "SDR", None))
        self.radioButton_hdr.setText(_translate("Form_mLut", "HDR", None))
